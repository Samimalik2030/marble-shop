...
const product = {
  ...
  breadcrumbs: [
    ...
    { id: "italian-marble", name: "Italian Marble", href: "/categories/italian-marble" },
  ],
}
            ...
            <Tabs defaultValue="description">
              ...
              <TabsContent value="description" className="py-4">
                <div className="prose max-w-none">
                  ...
                  <p>
                    Calacatta Gold is one of the most prestigious marbles in the world, quarried from the mountains of
                    Carrara, Italy. It's known for its distinctive gold veining that creates a dramatic contrast against
                    its bright white background.
                  </p>
                  <p>
                    This premium marble is characterized by its bold, dramatic veining patterns in gold and gray tones.
                    Each slab is unique, with variations in veining that make every installation a one-of-a-kind
                    masterpiece.
                  </p>
                  <p>
                    Calacatta Gold is particularly popular for luxury kitchens, bathrooms, and statement walls. Its
                    timeless beauty and prestigious reputation make it a favorite choice for high-end residential and
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="flex justify-between border-b pb-2">
                        ...
                        <span className="font-medium">135 MPa</span>
                      </li>
                      <li className="flex justify-between border-b pb-2">
                        <span className="text-muted-foreground">Flexural Strength</span>
                        <span className="font-medium">18.5 MPa</span>
                      </li>
                      <li className="flex justify-between border-b pb-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    <div className="border rounded-lg p-4">
                      <div className="flex justify-between mb-2">
                        <div>
                          <h4 className="font-medium">Absolutely Stunning</h4>
                          <div className="flex items-center">
                            {[...Array(5)].map((_, i) => (
                      ...
                      <p className="text-sm">
                        We installed Calacatta Gold in our kitchen and it's the centerpiece of our home. The gold
                        veining is spectacular and everyone who visits comments on it. Worth every penny for the luxury
                        it brings.
                      </p>
                      <div className="mt-2 text-sm font-medium">- Malik R.</div>
                    </div>

                    <div className="border rounded-lg p-4">
                      <div className="flex justify-between mb-2">
                        <div>
                          <h4 className="font-medium">True Luxury</h4>
                          <div className="flex items-center">
                            {[...Array(5)].map((_, i) => (
                              <Star key={i} className="h-4 w-4 text-yellow-400 fill-yellow-400" />
                            ))}
                      ...
                      <p className="text-sm">
                        As an interior designer, I've used many premium materials, but Calacatta Gold from Rajput
                        Marble's & Granite is exceptional. The quality is consistent and the veining is exactly what my
                        clients are looking for in luxury projects.
                      </p>
                      <div className="mt-2 text-sm font-medium">- Ayesha K.</div>
                    </div>
                  </div>
                </div>
              </TabsContent>
