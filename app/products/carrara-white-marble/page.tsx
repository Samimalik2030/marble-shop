            ...
            <Tabs defaultValue="description">
              ...
              <TabsContent value="description" className="py-4">
                <div className="prose max-w-none">
                  ...
                  <p>
                    Carrara marble is quarried in the city of Carrara in the Tuscany region of Italy and has been used
                    for sculpture and building decor for centuries. Michelangelo's David was carved from a block of
                    Carrara marble.
                  </p>
                  <p>
                    This premium marble is characterized by its soft white background with elegant gray veining. The
                    subtle veining pattern makes it versatile for a wide range of applications, from kitchen countertops
                    to bathroom vanities, flooring, and wall cladding.
                  </p>
                  <p>
                    While naturally porous, when properly sealed, Carrara marble is resistant to stains and suitable for
                    various applications throughout the home. Its timeless beauty adds a touch of luxury to any space.
                  </p>
                </div>
              </TabsContent>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="flex justify-between border-b pb-2">
                        ...
                        <span className="font-medium">131 MPa</span>
                      </li>
                      <li className="flex justify-between border-b pb-2">
                        <span className="text-muted-foreground">Flexural Strength</span>
                        <span className="font-medium">17.2 MPa</span>
                      </li>
                      <li className="flex justify-between border-b pb-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    <div className="border rounded-lg p-4">
                      <div className="flex justify-between mb-2">
                        <div>
                          <h4 className="font-medium">Exceptional Quality</h4>
                          <div className="flex items-center">
                            {[...Array(5)].map((_, i) => (
                      ...
                      <p className="text-sm">
                        The Carrara marble we purchased exceeded our expectations. The veining is subtle and elegant,
                        perfect for our kitchen countertops. Installation was smooth and the team was professional.
                      </p>
                    ...
                    <div className="border rounded-lg p-4">
                      <div className="flex justify-between mb-2">
                        <div>
                          <h4 className="font-medium">Beautiful Material</h4>
                          <div className="flex items-center">
                            {[...Array(5)].map((_, i) => (
                              <Star key={i} className="h-4 w-4 text-yellow-400 fill-yellow-400" />
                            ))}
                      ...
                      <p className="text-sm">
                        We used this marble for our bathroom renovation and it looks stunning. The quality is excellent
                        and it really elevates the space. Would definitely recommend.
                      </p>
                      <div className="mt-2 text-sm font-medium">- Faisal A.</div>
                    </div>
                  </div>
                </div>
              </TabsContent>
